...
Cabourotte is a tool which allow you to execute healthchecks (HTTP(s), TCP, DNS, TLS and certificate expiratio notice, arbitrary commands) on your infrastructure. It already supports various features including:
